...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FaxtoRestApiClientForJavascript.InlineResponse20014();
  });
  ...
  describe('InlineResponse20014', function() {
    it('should create an instance of InlineResponse20014', function() {
      ...
      //var instance = new FaxtoRestApiClientForJavascript.InlineResponse20014();
      //expect(instance).to.be.a(FaxtoRestApiClientForJavascript.InlineResponse20014);
    });
    ...
    it('should have the property areacodes (base name: "areacodes")', function() {
      // uncomment below and update the code to test the property areacodes
      //var instance = new FaxtoRestApiClientForJavascript.InlineResponse20014();
      //expect(instance).to.be();
    });
